extends SceneTree
## ARCHIVED: 32×24 / fertile-only / bush-clearing fixtures, retained for reference.
## These requirements were replaced by the compact-village user request.
## Current acceptance suite: res://tests/run_village_tests.gd
